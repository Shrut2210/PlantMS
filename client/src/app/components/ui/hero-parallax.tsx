...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[300vh] py-20 overflow-hidden bg-black  antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
